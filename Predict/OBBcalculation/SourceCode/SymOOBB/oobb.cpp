...
void mexFunction(int nlhs, mxArray *plhs[],
    ...
    /* Compute box */
    Vector3<double> *points, *samps, *facs;
    //SymBox3<double> box;
    ...
    SymBox3<double> bx = SymBox3<double>(nS, nV, nF, samps, points, facs, epsilon, queryType);
    delete1(points);
    delete1(samps);
    delete1(facs);
    ...
    plhs[1] = mxCreateDoubleMatrix(18, bx.getNumBoxes(), mxREAL);
    ...
    for(int i = 0; i < bx.getNumBoxes(); i++)
    {
