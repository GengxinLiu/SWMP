...
DatasetInfo = collections.namedtuple(
    'DatasetInfo',
    ['dataset_name', 'num_object', 'parts_map', 'num_parts', 'train_size', 'test_size', 'train_list', 'test_list',
     'spec_list', 'spec_map', 'exp', 'baseline', 'joint_baseline', 'style']
)
...
refrigerator=DatasetInfo(
        dataset_name='partnet2shapemotion',
        num_object=28,
        parts_map=[[0], [1], [2]],
        num_parts=3,
        train_size=67603,
        test_size=5036,
        train_list=None,
        test_list=["12059", "12066", "12248"],
        spec_list=["10143", "10655", "11712"],
        spec_map=None,
        ######## ANCSH ########
        exp='10.0',
        baseline='10.01',
    ...
    scissors=DatasetInfo(
        ...
        test_size=5036,
        train_list=None,
        test_list=["11089", "11099", "11100", "11103", "11111", "11113"],
        spec_list=["10569", "10960", "11029"],
        spec_map=None,
        ######## ANCSH ########
        exp='9.0',
        baseline='9.01',
    ...
    table=DatasetInfo(
        ...
        test_size=5036,
        train_list=None,
        test_list=["29557", "29921", "30341", "30869", "32174"],
        spec_list=["20453", "26073"],
        spec_map=None,
        ######## ANCSH ########
        exp='11.0',
        baseline='11.01',
    ...
    drawer=DatasetInfo(
        ...
        spec_list=[],
        spec_map={'40453': [3, 0, 1, 2], '44962': [3, 0, 1, 2], '45132': [3, 0, 1, 2], '45290': [3, 0, 1, 2],
                  '46123': [3, 0, 1, 2],
                  '46130': [3, 0, 1, 2], '46334': [3, 0, 1, 2], '46440': [3, 0, 1, 2], '46462': [3, 0, 1, 2],
                  '46537': [3, 0, 1, 2],
                  '46544': [3, 0, 1, 2], '46641': [3, 0, 1, 2], '47178': [3, 0, 1, 2], '47183': [3, 0, 1, 2],
                  '47296': [3, 0, 1, 2],
                  '47233': [3, 0, 1, 2], '48010': [3, 0, 1, 2], '48253': [3, 0, 1, 2], '48517': [3, 0, 1, 2],
                  '48740': [3, 0, 1, 2],
                  '48876': [3, 0, 1, 2], '46230': [3, 0, 1, 2],
                  '44853': [3, 1, 2, 0], '45135': [3, 1, 0, 2], '45427': [3, 2, 0, 1], '45756': [3, 1, 2, 0],
                  '45841': [0, 1, 2, 3],
                  '46653': [0, 1, 2, 3], '46879': [3, 1, 2, 0], '47438': [3, 2, 1, 0], '47711': [0, 1, 2, 3],
                  '48491': [0, 1, 2, 3]},
        exp='3.3',
        baseline='3.31',
        joint_baseline='5.4',
...
class global_info(object):
    def __init__(self):
        ...
        # self.base_path = "/mnt/disk2/gengxin/final/Extern/"
        self.base_path = os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), "..")) + "/"
